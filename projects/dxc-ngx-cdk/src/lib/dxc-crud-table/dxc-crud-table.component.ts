      ...
      switch ($event.rel) {
        ...
        case this.deleteRel:
          if (selectedRows.length <= 0) {
            ...
            const options = {
              title: this.config.configservice.Resources.confirmation,
              message: (this.parentForm.dirty && deleteRequest) ? this.config.configservice.Resources.crudGridDeleteSaveMsg : this.config.configservice.Resources.confirmDeleteMsg,
              cancelText: this.config.configservice.Resources.cancelButtonText,
              confirmText: this.config.configservice.Resources.confirmTitle
            };
